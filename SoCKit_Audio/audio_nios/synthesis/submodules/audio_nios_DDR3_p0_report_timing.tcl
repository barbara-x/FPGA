...
foreach inst $instances {
	...
	foreach opc $opcs {
		...
		audio_nios_DDR3_p0_perform_resync_timing_analysis $opcs $opcname $inst ${::GLOBAL_audio_nios_DDR3_p0_corename} $family scale_factors $io_std $interface_type $period pins t summary MP IP board fpga SSN
	...
	post_message -type critical_warning "Timing analysis was performed on core ${::GLOBAL_audio_nios_DDR3_p0_corename} using Quartus II v13.0 with a preliminary timing model and constraints. You must regenerate this IP in a future version of Quartus II to update the timing constraints to match the timing model."
	incr inst_id
}
