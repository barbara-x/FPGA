...
// 
// Generated using ACDS version 13.0 144 at 2013.05.13.15:14:53
...
module audio_nios_DDR3_s0 (
	...
	audio_nios_DDR3_s0_addr_router addr_router (
	...
	audio_nios_DDR3_s0_addr_router_001 addr_router_001 (
	...
	audio_nios_DDR3_s0_id_router id_router (
	...
	audio_nios_DDR3_s0_id_router id_router_001 (
	...
	audio_nios_DDR3_s0_id_router id_router_002 (
	...
	audio_nios_DDR3_s0_id_router_003 id_router_003 (
	...
	audio_nios_DDR3_s0_id_router id_router_004 (
	...
	audio_nios_DDR3_s0_id_router id_router_005 (
	...
	audio_nios_DDR3_s0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_mux_003 cmd_xbar_mux_003 (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 rsp_xbar_demux (
		.clk                (avl_clk),                           //       clk.clk
		.reset              (rst_controller_reset_out_reset),    // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 rsp_xbar_demux_001 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 rsp_xbar_demux_002 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_rsp_xbar_demux_003 rsp_xbar_demux_003 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 rsp_xbar_demux_004 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_cmd_xbar_demux_001 rsp_xbar_demux_005 (
		.clk                (avl_clk),                               //       clk.clk
		.reset              (rst_controller_reset_out_reset),        // clk_reset.reset
	...
	audio_nios_DDR3_s0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (avl_clk),                               //       clk.clk
		.reset               (rst_controller_reset_out_reset),        // clk_reset.reset
